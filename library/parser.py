...
class Parser:
    ...
    def get_all_tabls_from_database(self):
        table_list = []
    ...
    def get_specify_table_from_database(self, area):
        table_list = []
        for table in self.get_all_tabls_from_database():
    ...
    def get_house_id(self, table):
        return self.get_data_from_table(table)[3][1].split("/")[-1].replace(".html", "")
